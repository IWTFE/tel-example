...
import {JWechChatManager, JVccBarAssist} from './core/jbarassist.js';
window.application   = null;

//电话条显示类型
window.showStyleNONE  = 0;
window.showStyleOCX   = 1;
window.showStyleJS    = 2;
window.showStyleAUTTO = 3;
window.showStyleSL    = 4;

//实际电话条类型使用类型
window.vccBarTypeOCX     = 0;
window.vccBarTypeHTML5   = 1;
window.vccBarTypeSILVERLIGHT       = 2;
/////////////////////////////////
//     全局对外函数
/////////////////////////////////
...
function applicationLoad(left,top,width,height,showstyle,relationPath,callback){
	...
	// }
    relationPath = "app/"
    loadJsFile(relationPath+"scripts/tel/core/jbardef.js");
    loadJsFile(relationPath+"scripts/tel/core/japsp.js");
    loadJsFile(relationPath+"scripts/tel/core/jpublic.js");
    loadJsFile(relationPath+"scripts/tel/core/jmonitor.js");
    loadJsFile(relationPath+"scripts/tel/core/jslctrl.js");
  	loadJsFile(relationPath+"scripts/tel/core/jhtml5ctrl.js");
    loadJsFile(relationPath+"scripts/tel/core/jvccbar.js");

    loadJsFile(relationPath+"scripts/tel/jbarextent.js");
    loadJsFile(relationPath+"scripts/tel/jbardisplay.js");
  //   var bJsUi = false;
  //   var sleepTime = 1000;
...
window.loadHeadMeta = function(){
 ...
 window.loadJsFile = function(strFileName)
{
    var oHead = document.getElementsByTagName('HEAD').item(0);
...
window.loadCssFile = function(strFileName)
{
    var oHead = document.getElementsByTagName('HEAD').item(0);
...
window.IsWebsocketExist = function(){
...
window.IsWebSocketValid = function()
{
...
window.getLocalLanguage = function()
{
...
module.exports = {applicationLoad: applicationLoad}
